...
const FaceAnalyzer: React.FC = () => {
  ...
  useEffect(() => {
    if (faceShape !== "-" && previewUrl) {
      navigate("/photo-result/face-shape-type-result", {
        state: {
          faceShape,
          faceLength,
          faceWidth,
  ...
  }, [faceShape, previewUrl, navigate, faceLength, faceWidth, jawlineWidth, probabilities]);
            ...
            <div className="w-1/2">
              <div className="relative rounded-xl overflow-hidden shadow-2xl">
                <video
                  ...
                  playsInline
                >
                  <source src="/images/ai_face_shape_type_demo.mp4" type="video/mp4" />
                  您的浏览器不支持视频播放。
                </video>
              </div>
            </div>
