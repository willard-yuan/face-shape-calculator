...
var SessionRecording = /** @class */ (function () {
    ...
    Object.defineProperty(SessionRecording.prototype, "masking", {
        get: function () {
            ...
            var maskAllInputs = (_c = masking_client_side === null || masking_client_side === void 0 ? void 0 : masking_client_side.maskAllInputs) !== null && _c !== void 0 ? _c : masking_server_side === null || masking_server_side === void 0 ? void 0 : masking_server_side.maskAllInputs;
            var maskTextSelector = (_d = masking_client_side === null || masking_client_side === void 0 ? void 0 : masking_client_side.maskTextSelector) !== null && _d !== void 0 ? _d : masking_server_side === null || masking_server_side === void 0 ? void 0 : masking_server_side.maskTextSelector;
    ...
    SessionRecording.prototype._onScriptLoaded = function () {
        ...
        try {
            for (var _d = __values(Object.entries(userSessionRecordingOptions || {})), _e = _d.next(); !_e.done; _e = _d.next()) {
        ...
        if (this.masking) {
            ...
            sessionRecordingOptions.maskTextSelector = (_b = this.masking.maskTextSelector) !== null && _b !== void 0 ? _b : undefined;
        }
        if (!this.rrwebRecord) {
        ...
        this.mutationRateLimiter =
            (_c = this.mutationRateLimiter) !== null && _c !== void 0 ? _c : new MutationRateLimiter(this.rrwebRecord, {
